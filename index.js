...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* nestedFunction can access the variable internal as it is function level scope. nestedFunction is scoped to parent function -myFunction. nestedFunction only exist inside myFunction and gives abilitity to access myFunction. myFunction can pass variable down.*/
...
*/
function CuboidMaker(attrb){
  this.length = attrb.length;
  this.width = attrb.width;
  this. height = attrb.height;
}
...
/* 🐴🐴🐴 Step 2: Volume Method 🐴🐴🐴
  ...
  CuboidMaker.prototype.volume= function(){
    return `${attrb.length} * ${attrb.width} * ${attrb.height}`;
  }
